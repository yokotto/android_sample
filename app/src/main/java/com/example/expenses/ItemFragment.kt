...
class ItemFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = view.findViewById(R.id.fragment_item_recycler_view)

        val confirmButton = view.findViewById<Button>(R.id.fragment_item_confirmButton)
        val cancelButton = view.findViewById<Button>(R.id.fragment_item_cancelButton)
        ...
        scope.launch {
            ...
            withContext(Dispatchers.Main) {
                ...
                recyclerView.adapter = SpendingAdapter(this@ItemFragment.mSpendingList)
            }
        }
    ...
    inner class SpendingAdapter constructor(private var spendingList:List<SpendingEntity>):
            RecyclerView.Adapter<ItemFragment.SpendingAdapter.ItemViewHolder>() {
